...
const TopNav = (props: any) => {
  return (
    <nav className='fixed h-[70px] w-screen z-10 px-8 tall:px-12 lg:px-16 flex 2xl:justify-center items-center bg-old-lace drop-shadow-lg' aria-label='Navigation Menu'>
