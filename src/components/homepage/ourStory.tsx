...
const OurStory = () => {
  return (
    <section id='our-story' className='h-fit sm:h-[75vh] md:h-[52.5vh] lg:h-[75vh] w-screen px-8 lg:px-16 py-8 flex flex-col justify-center items-center sm:items-start gap-4 sm:gap-8 lg:gap-12 bg-old-lace' aria-label='Our Story'>
