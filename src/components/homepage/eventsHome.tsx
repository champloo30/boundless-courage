...
const EventsHome = () => {
  return (
    <section id='events-home' className='h-[30vh] sm:h-[40vh] md:h-[25vh] lg:h-[45vh] w-screen flex flex-col justify-center items-center gap-4 sm:gap-6 lg:gap-8 bg-fade' aria-label='events'>
