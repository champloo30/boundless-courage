...
const TIMS = () => {
  return (
    <section id='tims' className='h-[60vh] sm:h-[70vh] md:h-[47.5vh] tall:h-[47.5vh] lg:h-[80vh] w-screen px-8 tall:px-12 flex flex-col justify-center items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 bg-old-lace' aria-label='This Is My Story'>
