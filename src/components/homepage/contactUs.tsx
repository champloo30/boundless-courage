...
const ContactUs = () => {
  return (
    <section id='contact-us' className='h-[30vh] sm:h-[40vh] md:h-[25vh] tall:h-[25vh] lg:h-[45vh] w-screen px-8 flex flex-col justify-center items-center gap-4 sm:gap-6 lg:gap-8 bg-purple text-old-lace' aria-label='contact us'>
